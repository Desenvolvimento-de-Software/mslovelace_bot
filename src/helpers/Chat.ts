...
export default class ChatHelper {
     ...
     */
    public static async getById(id: number): Promise<Chatype|undefined> {
        ...
        const chat = await chats.execute<Chatype[]>();
        if (chat.length) {
            return chat[0];
        }
     ...
     * @param chatId
     *
     * @return {Promise<Chatype|undefined>}
     */
    public static async getByTelegramId(chatId: number): Promise<Chatype|undefined> {
